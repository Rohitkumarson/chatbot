    ...
    try:
        ...
        # Handle email/phone collection
            ...
            if email_match:
                ...
                connection_state["state"] = STATE_WAITING_FOR_PHONE
                return f"Thank you for providing your email: {fake_db['email']}. Could you also provide your phone number?"
            else:
            ...
            if phone_match:
                ...
                return f"Thank you for providing your phone number: {fake_db['phone_number']}. Our agent will contact you as soon as possible. Let me know if you need help!"
            else:
