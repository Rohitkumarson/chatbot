...
from model.request_model import QueryRequest,EmailSchema
from service.chat_service import extract_text_from_txt,process_text_for_vectorstore,vector_store,openai_api_key,ConnectionState,get_agent_request,STATE_WAITING_FOR_EMAIL,STATE_WAITING_FOR_PHONE,STATE_COLLECTED,STATE_INITIAL,SIMILARITY_THRESHOLD,generator,text_to_speech,fake_db,send_email
from service.fallback import random_valid_name,random_valid_name_for_voice,get_random_fallback_response,get_random_fallback_response_for_voice
